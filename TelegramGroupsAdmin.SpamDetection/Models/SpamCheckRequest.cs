...
/// <summary>
/// Request structure for spam detection, based on tg-spam's Request model
/// </summary>
public record SpamCheckRequest
{
    ...
    /// </summary>
    public SpamCheckMetadata Metadata { get; init; } = new();

    /// <summary>
    /// Chat ID for per-chat configuration (string for compatibility)
    /// </summary>
...
/// </summary>
public record SpamCheckMetadata
{
    /// <summary>
