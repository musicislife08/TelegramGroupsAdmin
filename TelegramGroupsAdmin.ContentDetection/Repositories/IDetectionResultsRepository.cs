...
public interface IDetectionResultsRepository
{
    ...
    /// </summary>
    Task<List<DetectionResultRecord>> GetByMessageIdAsync(int messageId, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Dictionary<int, List<DetectionResultRecord>>> GetDetectionHistoryBatchAsync(IEnumerable<int> messageIds, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task InvalidateTrainingDataForMessageAsync(int messageId, CancellationToken cancellationToken = default);
