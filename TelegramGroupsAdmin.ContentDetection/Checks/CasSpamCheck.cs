...
public class CasSpamCheck : IContentCheck
{
    ...
    /// </summary>
    private ContentCheckResponse CreateResponse(CasResponse casResponse, bool fromCache)
    {
    ...
    /// </summary>
    private ContentCheckResponse CreateFailResponse(string details, Exception? error = null)
    {
        return new ContentCheckResponse
        {
            CheckName = CheckName,
