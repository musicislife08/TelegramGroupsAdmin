...
public class OpenAIContentCheck : IContentCheck
{
    ...
    /// </summary>
    private ContentCheckResponse CreateResponse(OpenAIResponse openaiResponse, OpenAICheckRequest req, bool fromCache)
    {
    ...
    /// </summary>
    private ContentCheckResponse CreateFallbackResponse(string reason, bool fromCache)
    {
    ...
    /// </summary>
    private ContentCheckResponse CreateLegacyResponse(string content, OpenAICheckRequest req, bool fromCache)
    {
