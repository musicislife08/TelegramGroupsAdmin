...
{
    private (int PermissionLevel, string? UserId) GetUserInfo()
    {
    ...
    private string? ValidateExportPermission()
    {
        var (permissionLevel, userId) = GetUserInfo();
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var userId = ValidateExportPermission();
