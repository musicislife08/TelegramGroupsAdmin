...
public class AuthCookieService : IAuthCookieService
{
    ...
    /// </summary>
    public async Task SignInAsync(HttpContext context, string userId, string email, PermissionLevel permissionLevel, string securityStamp)
    {
        var principal = CreateClaimsPrincipal(userId, email, permissionLevel, securityStamp);
    ...
    /// </summary>
    public string GenerateCookieValue(string userId, string email, PermissionLevel permissionLevel, string securityStamp)
    {
    ...
    /// </summary>
    private static ClaimsPrincipal CreateClaimsPrincipal(string userId, string email, PermissionLevel permissionLevel, string securityStamp)
    {
