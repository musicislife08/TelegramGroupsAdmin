...
public interface IReportActionsService
{
    ...
    Task<ReviewActionResult> HandleContentSpamAsync(long reportId, Actor executor, CancellationToken cancellationToken = default);
    ...
    Task<ReviewActionResult> HandleProfileScanKickAsync(long alertId, Actor executor, CancellationToken cancellationToken = default);
    Task<ReviewActionResult> HandleProfileScanAllowAsync(long alertId, Actor executor, CancellationToken cancellationToken = default);

    // Impersonation actions
    Task<ReviewActionResult> HandleImpersonationConfirmAsync(long alertId, Actor executor, CancellationToken cancellationToken = default);
    Task<ReviewActionResult> HandleImpersonationDismissAsync(long alertId, Actor executor, CancellationToken cancellationToken = default);
    Task<ReviewActionResult> HandleImpersonationTrustAsync(long alertId, Actor executor, CancellationToken cancellationToken = default);
