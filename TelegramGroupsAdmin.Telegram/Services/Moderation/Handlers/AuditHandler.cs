...
public class AuditHandler : IAuditHandler
{
    ...
    /// <inheritdoc />
    public async Task LogBanAsync(long userId, Actor executor, string? reason, CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task LogTempBanAsync(long userId, Actor executor, TimeSpan duration, string? reason, CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task LogUnbanAsync(long userId, Actor executor, string? reason, CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task LogWarnAsync(long userId, Actor executor, string? reason, CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task LogTrustAsync(long userId, Actor executor, string? reason, CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task LogUntrustAsync(long userId, Actor executor, string? reason, CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task LogDeleteAsync(long messageId, long chatId, long userId, Actor executor, CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task LogRestrictAsync(long userId, long chatId, Actor executor, string? reason, CancellationToken ct = default)
    {
