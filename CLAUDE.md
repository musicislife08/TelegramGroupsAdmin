...
## PENDING MIGRATIONS (Dev Machine)

### AddUniqueConstraintToMessageTranslations
**Commit:** 45b8d76 (2025-10-24)
**Status:** Code committed, migration file NOT yet created

**What changed:**
- AppDbContext.cs lines 410-417: Added `.IsUnique()` to message_translations indexes
- MessageHistoryRepository.cs: Added LEFT JOIN to load translations, upsert pattern in InsertTranslationAsync

**Migration commands:**
```bash
cd TelegramGroupsAdmin.Data
dotnet ef migrations add AddUniqueConstraintToMessageTranslations
dotnet ef database update
```

**Why needed:**
- Prevents duplicate translations for same message/edit
- Makes manual translations persist across page refreshes
- Duplicate already deleted from production DB (id=1)

**After migration, remove this section from CLAUDE.md**
