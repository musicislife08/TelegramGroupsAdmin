...
public interface IAIServiceFactory
{
    ...
    Task<AIFeatureStatus> GetFeatureStatusAsync(AIFeatureType feature, CancellationToken ct = default);
    ...
    Task<IReadOnlyList<AIConnection>> GetConnectionsAsync(CancellationToken ct = default);
    ...
    Task<AIFeatureConfig?> GetFeatureConfigAsync(AIFeatureType feature, CancellationToken ct = default);
    ...
    Task<IReadOnlyList<AIModelInfo>> RefreshModelsAsync(string connectionId, CancellationToken ct = default);
}
