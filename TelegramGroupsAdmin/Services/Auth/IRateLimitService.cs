...
public interface IRateLimitService
{
    ...
    /// </summary>
    Task<RateLimitCheckResult> CheckRateLimitAsync(string identifier, string endpointKey, CancellationToken ct = default);

    /// <summary>
    /// Records an attempt for rate limiting
    /// </summary>
    Task RecordAttemptAsync(string identifier, string endpointKey, CancellationToken ct = default);
}
