...
(82619, -1001322973935, 0, 100001, NOW() - INTERVAL '1 day', 'Manual spam marking via /report command', NULL),
-- Label2: Msg2 (82618) marked as spam (no user attribution)
(82618, -1001322973935, 0, NULL, NOW() - INTERVAL '2 days', 'Confirmed spam pattern', NULL),
-- Label3: Msg3 (82617) corrected to ham by User2 (bob_chat)
(82617, -1001322973935, 1, 100002, NOW() - INTERVAL '3 days', 'Admin correction - false positive', NULL),
-- Label4: Msg4 (82616) marked as ham (no reason, no user)
(82616, -1001322973935, 1, NULL, NOW() - INTERVAL '4 days', NULL, NULL),
-- Label5: Msg5 (82615) marked as spam (no reason, no user)
(82615, -1001322973935, 0, NULL, NOW() - INTERVAL '5 days', NULL, NULL);
