...
(1, 0, '{{
  ...
  "MinMessageLength": 10,
  "AutoBanThreshold": 4.0,
  "ReviewQueueThreshold": 2.5,
  "MaxConfidenceVetoThreshold": 4.25,
  "TrainingMode": false,
  "StopWords": {{ "UseGlobal": true, "Enabled": true, "ConfidenceThreshold": 2.5, "AlwaysRun": false }},
  ...
  "Bayes": {{ "UseGlobal": true, "Enabled": true, "MinSpamProbability": 2.5, "AlwaysRun": false }},
  ...
  "AIVeto": {{ "UseGlobal": true, "Enabled": true, "CheckShortMessages": false, "MessageHistoryCount": 3, "ConfidenceThreshold": 4.25, "AlwaysRun": false }},
