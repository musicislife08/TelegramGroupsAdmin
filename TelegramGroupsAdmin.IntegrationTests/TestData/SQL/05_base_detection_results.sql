...
(82619, -1001322973935, NOW() - INTERVAL '1 hour', 'System', 'InvisibleChars, StopWords, CAS, Similarity, Bayes, Spacing', 0, 'No spam detected', 'spam-detection-v1', FALSE, 0, 0),
-- Result2: Msg11 (82581) "I hit 30 last summer" - low confidence spam probability (37%)
(82581, -1001322973935, NOW() - INTERVAL '2 hours', 'System', 'InvisibleChars, StopWords, CAS, Similarity, Bayes, Spacing', 37, 'Spam probability: 0.752 (key words: hit) (certainty: 0.504)', 'spam-detection-v1', FALSE, 37, 0);
