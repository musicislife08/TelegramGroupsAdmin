...
/// <summary>
/// Fluent builder for creating test users in WASM UI E2E tests.
/// Uses Ui.Server's service interfaces.
/// </summary>
/// <remarks>
/// Example usage:
/// <code>
/// var password = TestCredentials.GeneratePassword();
/// var user = await new WasmTestUserBuilder(Factory.Services)
...
/// </code>
/// </remarks>
public class WasmTestUserBuilder
{
    ...
    public WasmTestUserBuilder(IServiceProvider services)
    {
        _services = services;
    }
    ...
    /// </summary>
    public WasmTestUserBuilder WithEmail(string email)
    {
        _email = email;
        return this;
    }
    ...
    /// </summary>
    public WasmTestUserBuilder WithPassword(string password)
    {
        _password = password;
        return this;
    }
    ...
    /// </summary>
    public WasmTestUserBuilder WithPasswordHash(string passwordHash)
    {
    ...
    /// </summary>
    public WasmTestUserBuilder WithPermissionLevel(PermissionLevel level)
    {
    ...
    /// </summary>
    public WasmTestUserBuilder AsOwner() => WithPermissionLevel(PermissionLevel.Owner);

    /// <summary>
    /// Sets the user as GlobalAdmin.
    /// </summary>
    public WasmTestUserBuilder AsGlobalAdmin() => WithPermissionLevel(PermissionLevel.GlobalAdmin);

    /// <summary>
    /// Sets the user as Admin (default).
    /// </summary>
    public WasmTestUserBuilder AsAdmin() => WithPermissionLevel(PermissionLevel.Admin);

    /// <summary>
    /// Sets the user's status.
    /// Default is Active.
    /// </summary>
    public WasmTestUserBuilder WithStatus(UserStatus status)
    {
        _status = status;
        return this;
    }
    ...
    /// </summary>
    public WasmTestUserBuilder WithEmailVerified(bool verified = true)
    {
    ...
    public WasmTestUserBuilder WithTotp(bool enabled = true, string? secret = null)
    {
    ...
    /// </summary>
    public WasmTestUserBuilder WithTotpDisabled()
    {
        _totpEnabled = false;
        _totpSecret = null;
        return this;
    ...
    /// </summary>
    public WasmTestUserBuilder RequiresTotpSetup()
    {
        _totpEnabled = true;
    ...
    /// </summary>
    public WasmTestUserBuilder LockedUntil(DateTimeOffset lockedUntil)
    {
    ...
    /// </summary>
    public WasmTestUserBuilder LockedFor(TimeSpan duration)
    {
    ...
    /// </summary>
    public WasmTestUserBuilder WithFailedLoginAttempts(int count)
    {
    ...
    /// Returns a WasmTestUser containing the user record and credentials for testing.
    /// </summary>
    public async Task<WasmTestUser> BuildAsync(CancellationToken cancellationToken = default)
    {
        ...
        return new WasmTestUser(userRecord, password, unencryptedTotpSecret);
    }
...
/// <summary>
/// Represents a test user with credentials for WASM E2E testing.
/// Uses UserRecord from TelegramGroupsAdmin.Ui.Server.Repositories.
/// </summary>
public record WasmTestUser(
    /// <summary>
